...
export default function Home() {
  ...
  return (
    <div>
      ...
      {/* Alert - New Event Registration */}
      {showAlert && (
        <div className="fixed top-0 left-0 right-0 bg-green-600 text-white p-4 z-50 animate-slide-down">
          <div className="container mx-auto flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <span className="font-semibold">New Event Registration Open! </span>
                <span className="hidden md:inline">Time remaining: </span>
